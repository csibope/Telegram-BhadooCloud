module.exports = Object.freeze({
  TOKEN: '1082133964:AAGMXYulo4Qv2U_KSbe145l9t39R7iYpIZ8', //required
  ARIA_SECRET: 'leecht', //change as per needs.
  ...
  SUDO_USERS: [325841521],	// Telegram user IDs. These users can use the bot in any chat. required, get it using https://t.me/YourTGid_Bot
  AUTHORIZED_CHATS: [-1001483348489],	// Telegram chat IDs. Anyone in these chats can use the bot. Add https://t.me/YourTGid_Bot to Group and click /id
  ...
  DOWNLOAD_NOTIFY_TARGET: {  // Information about the web service to notify on download completion. not required
    ...
    COMMANDS_USE_BOT_NAME: {
      ...
      NAME: "@BotLeechT_Bot" //Enter your Bot Username here if above is set to true.
    }
});
